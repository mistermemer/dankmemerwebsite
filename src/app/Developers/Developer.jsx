  ...
  render() {
    let accounts = this.props.social.map(account => {
      return <a key={`${this.props.name}-${account.name}`} href={account.link}>
        <img className="developer-account" alt={`${this.props.name}'s ${account.name} link`} src={`${account.name}.svg`}></img>
      </a>
    })
    return(
      <div className="developer">
        ...
        <div className="developer-social">
          <img className="developer-picture" alt={`${this.props.name}'s avatar`} src={`/${this.props.picture}`} 
