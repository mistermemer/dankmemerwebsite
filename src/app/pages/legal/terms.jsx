...
export default function Terms() {
  	return (
    	<div id="legal">
			<div id="legal-header">
				<h1 id="legal-header-title">Terms of Service</h1>
				<p id="legal-header-subtitle">Last updated: July 7th, 2019</p>
			</div>
			<div className="legal-paragraph">
				...
				<p className="legal-paragraph-body">
					Your access to and use of the Service is conditioned upon your acceptance of and compliance with these Terms. These
			...
			<div className="legal-paragraph">
    			<h2 className="legal-paragraph-title">Purchases</h2>
    			<p className="legal-paragraph-body">
					If you wish to purchase any product or service made available through the Service ("Purchase"), you may be asked to 
				...
				<p className="legal-paragraph-body">
					The service may employ the use of third party services for the purpose of facilitating payment and the completion of
			...
			<div className="legal-paragraph">
				<h2 className="legal-paragraph-title">Availability, Errors and Inaccuracies</h2>
				<p className="legal-paragraph-body">
					We are constantly updating product and service offerings on the Service. We may experience delays in updating
					information on the Service and in our advertising on other web sites. The information found on the Service may contain
					errors or inaccuracies and may not be complete or current. Products or services may be mispriced, described inaccurately,
					or unavailable on the Service and we cannot guarantee the accuracy or completeness of any information found on the Service.
				</p>
				<p className="legal-paragraph-body">
			...
			<div className="legal-paragraph">
				<h2 className="legal-paragraph-title">Links To Other Web Sites</h2>
				<p className="legal-paragraph-body">
					Our Service may contain links to third party web sites or services that are not owned or controlled by Melms Media LLC
				</p>
				<p className="legal-paragraph-body">
					Melms Media LLC has no control over, and assumes no responsibility for the content, privacy policies, or practices of any
					third party web sites or services. We do not warrant the offerings of any of these entities/individuals or their websites.
				</p>
				<p className="legal-paragraph-body">
					You acknowledge and agree that Melms Media LLC shall not be responsible or liable, directly or indirectly, for any damage
			...
			<div className="legal-paragraph">
				<h2 className="legal-paragraph-title">Termination</h2>
				<p className="legal-paragraph-body">
			...
			<div className="legal-paragraph">
				<h2 className="legal-paragraph-title">Indemnification</h2>
				<p className="legal-paragraph-body">
					You agree to defend, indemnify and hold harmless Melms Media LLC and its licensee and licensors, and their employees,
			...
			<div className="legal-paragraph">
				<h2 className="legal-paragraph-title">Limitation Of Liability</h2>
				<p className="legal-paragraph-body">
					In no event shall Melms Media LLC, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable
			...
			<div className="legal-paragraph">
				<h2 className="legal-paragraph-title">Disclaimer</h2>
				<p className="legal-paragraph-body">
				...
				<p className="legal-paragraph-body">
					Melms Media LLC its subsidiaries, affiliates, and its licensors do not warrant that a&#41; the Service will function
			...
			<div className="legal-paragraph">
				<h2 className="legal-paragraph-title">Exclusions</h2>
				<p className="legal-paragraph-body">
			...
			<div className="legal-paragraph">
				<h2 className="legal-paragraph-title">Governing Law</h2>
				<p className="legal-paragraph-body">
					These Terms shall be governed and construed in accordance with the laws of North Carolina, United States, without regard to its
			...
			<div className="legal-paragraph">
				<h2 className="legal-paragraph-title">Changes</h2>
				<p className="legal-paragraph-body">
				...
				<p className="legal-paragraph-body">
					By continuing to access or use our Service after any revisions become effective, you agree to be bound by the revised terms. If you do
					not agree to the new terms, you are no longer authorized to use the Service.
				</p>
			</div>
			<div className="legal-paragraph">
				<h2 className="legal-paragraph-title">Contact us</h2>
				<p className="legal-paragraph-body">
					If you have any questions about our Terms, please contact us by email: <a href="mailto:admin@dankmemer.gg">admin@dankmemer.gg</a>.
				</p>
			</div>
		</div>
  	)
